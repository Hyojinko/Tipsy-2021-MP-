...
import opuslib.opuslib.OpusPlayer;
import opuslib.opuslib.OpusRecorder;
import opuslib.opuslib.OpusTool;

public class opussample extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.opusactivity);
